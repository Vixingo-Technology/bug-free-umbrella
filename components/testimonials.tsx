          ...
          {testimonials.map((t, i) => (
            ...
            >
              ...
              <div className="flex items-center gap-4 relative z-10">
                ...
                <div>
                  <h4 className="text-zinc-900 font-bold tracking-wider uppercase text-sm">{t.author}</h4>
                  <p className="text-zinc-500 font-bold text-[10px] uppercase tracking-widest">{t.role}</p>
                </div>
              </div>
            </motion.div>
          ))}
