...
export default function CTA() {
  return (
    <section id="membership" className="relative py-40 bg-bg-deep flex items-center justify-center overflow-hidden">
      {/* Background Image */}
      ...
      <div className="relative z-20 max-w-4xl mx-auto px-6 text-center">
        ...
        >
          <h2 className="font-serif text-5xl md:text-7xl text-zinc-900 mb-6 leading-tight tracking-tighter font-bold">
            ...
            <span className="italic text-accent-red font-serif font-normal text-4xl md:text-5xl uppercase tracking-widest block mt-2">toward mastery</span>
          </h2>
