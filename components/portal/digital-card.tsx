...
export type MembershipStatusLabel = "Active" | "Expired" | "Expiring Soon" | "Pending";
            ...
            <div className="relative z-10 flex flex-col h-full">
                <div className="flex items-start justify-between mb-5">
                    <div className="flex items-center gap-2">
                        <div
                            ...
                            style={{ backgroundColor: beltColor, boxShadow: `0 0 10px ${beltColor}55` }}
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                        <h3 className="text-lg font-bold leading-tight truncate">{fullName || "Member"}</h3>
                        {email && <p className="text-zinc-400 text-xs mt-0.5 truncate">{email}</p>}
                        {memberNumber && (
                ...
                <div className="mt-auto grid grid-cols-2 gap-3 pt-5 border-t border-zinc-700/50">
                    ...
                    <div>
                        ...
                        <p className="text-xs font-semibold mt-0.5 truncate">{dojoName ?? "—"}</p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p className="text-xs font-semibold mt-0.5">{role ?? "Student"}</p>
                    </div>
                </div>
            </div>
        </div>
