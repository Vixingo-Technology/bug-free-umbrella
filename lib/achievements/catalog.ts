...
export const ACHIEVEMENT_CATALOG: readonly CatalogEntry[] = [
    ...
    { slug: "double-promotion",  name: "Double Promotion",   nameBn: "ডাবল প্রমোশন",        description: "Score 80 or above in a belt test and skip a rank.", descriptionBn: "বেল্ট পরীক্ষায় ৮০+ নম্বর পেয়ে একটি র‍্যাঙ্ক এড়িয়ে যান।", icon: "ChevronsUp",  tier: "EPIC",      rule: "HIGH_MARK_GRADINGS",      threshold: 1,   orderIndex: 155 },
