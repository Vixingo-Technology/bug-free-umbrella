...
insert into belt_ranks (name, kyu_dan, color_hex, order_index, updated_at) values
  ...
  ('Brown Belt',         '1st Kyu', '#8B4513',  5, now()),
  ('Black Belt 1st Dan', '1st Dan', '#1a1a1a',  6, now()),
  ('Black Belt 2nd Dan', '2nd Dan', '#1a1a1a',  7, now()),
  ('Black Belt 3rd Dan', '3rd Dan', '#1a1a1a',  8, now()),
  ('Black Belt 4th Dan', '4th Dan', '#1a1a1a',  9, now()),
  ('Black Belt 5th Dan', '5th Dan', '#1a1a1a', 10, now())
