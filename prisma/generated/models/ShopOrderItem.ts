...
// @ts-nocheck 
/*
 * This file exports the `ShopOrderItem` model and its related types.
 *
...
export type GetShopOrderItemAggregateType<T extends ShopOrderItemAggregateArgs> = {
      [P in keyof T & keyof AggregateShopOrderItem]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateShopOrderItem[P]>
    : Prisma.GetScalarType<T[P], AggregateShopOrderItem[P]>
}
...
export type GetShopOrderItemGroupByPayload<T extends ShopOrderItemGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ShopOrderItemGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ShopOrderItemGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ShopOrderItemGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ShopOrderItemGroupByOutputType[P]>
      }
    >
  >
...
export type ShopOrderItemWhereInput = {
  ...
  id?: Prisma.UuidFilter<"ShopOrderItem"> | string
  orderId?: Prisma.UuidFilter<"ShopOrderItem"> | string
  productId?: Prisma.UuidFilter<"ShopOrderItem"> | string
...
export type ShopOrderItemScalarWhereWithAggregatesInput = {
  ...
  id?: Prisma.UuidWithAggregatesFilter<"ShopOrderItem"> | string
  orderId?: Prisma.UuidWithAggregatesFilter<"ShopOrderItem"> | string
  productId?: Prisma.UuidWithAggregatesFilter<"ShopOrderItem"> | string
...
export type ShopOrderItemCreateInput = {
  ...
  order: Prisma.ShopOrderCreateNestedOneWithoutOrderItemsInput
...
export type ShopOrderItemUpdateInput = {
  ...
  order?: Prisma.ShopOrderUpdateOneRequiredWithoutOrderItemsNestedInput
...
export type ShopOrderItemOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "orderId" | "productId" | "quantity" | "unitPrice", ExtArgs["result"]["shopOrderItem"]>
...
export type ShopOrderItemCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ShopOrderItemFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ShopOrderItemDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ShopOrderItem'], meta: { name: 'ShopOrderItem' } }
  /**
   ...
   * })
  **/
  count<T extends ShopOrderItemCountArgs>(
    args?: Prisma.Subset<T, ShopOrderItemCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ShopOrderItemCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ShopOrderItemGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ShopOrderItemGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetShopOrderItemGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
